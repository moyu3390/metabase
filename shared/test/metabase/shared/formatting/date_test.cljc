...
(deftest format-for-parameter-test
  (testing "some units have custom formatting"
    (are [exp date unit] (= exp (date/format-for-parameter (shared.ut/parse-timestamp date) {:unit unit}))
      ;; Years
  ...
  (testing "other units are treated as days or day ranges"
    (are [exp date unit] (= exp (date/format-for-parameter (shared.ut/parse-timestamp date)
                                                           {:unit   unit
...
(deftest format-range-with-unit-test
  (letfn [(week-of [d]
...
(deftest format-datetime-with-unit-test
